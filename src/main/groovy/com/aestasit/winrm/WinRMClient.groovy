...
//    private int chunk = 0;
  ...
  public WinRmClient(
      ...
      final String password, final URL targetURL, final String unmappedAddress, final int unmappedPort) {
...
//      }
  ...
  private
  static void handleStream(Document responseDocument, ResponseExtractor stream, OutputStream out) throws IOException {
...
//      httpclient.getConnectionManager().getSchemeRegistry().register(sch);
  ...
  private void configureAuthentication(
      final DefaultHttpClient httpclient, final String scheme, final Principal principal) {
